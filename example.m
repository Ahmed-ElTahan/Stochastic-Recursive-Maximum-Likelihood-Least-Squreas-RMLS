%
%{
        This is an example to show how to use the RecursiveModifiedExtendedLeastSquares (RMELS)
...
%% Estimation using RecursiveModifiedExtendedLeastSquares function
[ theta, Gz_estm ] = RecursiveModifiedExtendedLeastSquares( u, y, 2, 1, 1, 2, Ts) % 2nd RMELS order estimation
